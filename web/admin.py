...
class NoteAdmin(admin.ModelAdmin):
    list_display = ('id', 'class_name', 'teacher_name', 'has_file', 'has_text', 'created_at', 'file_size')
    list_filter = ('class_obj', 'teacher', 'created_at', 'class_obj__teachers')
    search_fields = ('class_obj__name', 'teacher__user__username', 'text')
